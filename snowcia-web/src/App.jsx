...
function ServiceEditor({ editor, onClose, onSave, loading }) {
  const initial = editor.item ?? { name: "", description: "", category: "OTHER", target: "DOG", billingType: "DAILY", durationMinutes: "", active: true, allowDateSelection: true, allowTimeSelection: false, allowCustomerNotes: true, allowCheckInOut: false, maxPets: "", priceConditions: [{ name: "Segunda a quinta", price: "" }] };
